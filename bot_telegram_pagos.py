...
PALABRAS_BLOQUEADAS = [
    "void", "enigma", "telegram", "instagram", "vk", "pasaporte", "fotos", 
    "documentos", "datos", "estafa", "crypto", "bitcoin", "casino", "apuestas",
    "бот", "поиск", "человека", "фото", "номер", "паспорт", "авто", "госномер",
    "аккаунт", "пароль", "логин", "инстаграм", "телеграм", "вконтакте", "вк",
    "проверка", "пробива", "найти", "информация", "удаления", "разбана",
    "follower", "likes", "views", "follow", "boost", "engagement"
]
